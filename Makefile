...
godoc: ## Display documentation for the package
	...
	@echo "* http://localhost:6060/pkg/github.com/demisto/go-elasticsearch/v8"
	@echo "* http://localhost:6060/pkg/github.com/demisto/go-elasticsearch/v8/esapi"
	@echo "* http://localhost:6060/pkg/github.com/demisto/go-elasticsearch/v8/estransport"
	@echo "* http://localhost:6060/pkg/github.com/demisto/go-elasticsearch/v8/esutil"
	@printf "\n"
